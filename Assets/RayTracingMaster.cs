...
public class RayTracingMaster : MonoBehaviour
{
    ...
    private void CreateLighting() 
    {
        ...
        // LIGHTING OPTION 1:
        s.position = new Vector3(0.0f, 2.5f, 0.0f);
        s.radius = 0.1f;
        s.emission = new Vector3(0.9f, 0.8f, 0.1f);
        s.albedo = new Vector3(0.5f, 0.1f, 0.3f);
        s.specular = new Vector3(0.5f, 0.1f, 0.3f);
        s.smoothness = 0;

        // LIGHTING OPTION 2:
        /* s.position = new Vector3(0.0f, 2.5f, 0.0f);
         s.radius = 0.1f;
         s.emission = new Vector3(2, 2, 1);
         s.albedo = new Vector3(1, 1, 1);
         s.specular = new Vector3(1, 1, 1);
         s.smoothness = 0;*/
